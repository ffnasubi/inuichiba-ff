...
const msgB7 = "動画は有償になりかねないので止めましたー！\n画像サンプルくださーい!\nでも本当はflexメッセージが一番データとしては小さいでーす!";
...
const textMessages = {
  ...
  "tap_richMenuB1": [ { type: "text", text: msgA1 } ],
  "tap_richMenuA4": [
...
const mediaMessages = {
  "tap_richMenuB7": [
    { type: "text", text: msgB7 },
    {
      type: "image",
      originalContentUrl: `${baseDir}images/dogWait.jpg`,
...
const textTemplates = {
  ...
  "tap_richMenuB8": "イベントを楽しむためのグッドマナーです$以下省略$"
};
...
module.exports = {
  ...
  msgB30,msgB31,msgB32,
  msgB4,
  msgB5,
  msgB60,msgB61,msgB62,
  msgJoin,
  msgY,
  msgPostpone
};
