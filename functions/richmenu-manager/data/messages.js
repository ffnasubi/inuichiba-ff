...
const textMessages = {
  ...
  "tap_richMenuA2": [
									    { type: "text", text: msgA21 },
    									{ type: "text", text: msgA22 }
  									],
  "tap_richMenuA6": [
  ...
  "tap_richMenuB3": [ { type: "text", text: msgB3 } ],
  "tap_richMenuB4": [ { type: "text", text: msgB4 } ],
  "tap_richMenuB5": [ { type: "text", text: msgB5 } ],
...
const textTemplates = {
  ...
  "tap_richMenuB2": "イベントを楽しむためのグッドマナーです$以下省略$"
};
